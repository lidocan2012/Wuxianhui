...
public abstract class BaseWspuservisithistory  implements Serializable {
	 ...
	 */
	public BaseWspuservisithistory (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: UserID2
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.wifihi.persistence.Wspuservisithistory)) return false;
		else {
			com.wifihi.persistence.Wspuservisithistory wspuservisithistory = (com.wifihi.persistence.Wspuservisithistory) obj;
